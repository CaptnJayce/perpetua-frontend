...
export const NPCS: NpcDef[] = [
  ...
  {
    id: "worker-2",
    name: "Worker NPC 2/10",
    portrait: "/portrait-placeholder.jpg",
    bodyShot: "/body-shot-portrait.png",
    unlocked: false,
    unlockCondition: (_resources, flags) => flags.includes("unlock_worker_two"),
    role: "worker",
  },
  {
    id: "worker-3",
    name: "Worker NPC 3/10",
    portrait: "/portrait-placeholder.jpg",
    bodyShot: "/body-shot-portrait.png",
    unlocked: false,
    unlockCondition: (_resources, flags) => flags.includes("unlock_worker_three"),
    role: "worker",
  },
  {
    id: "gaige",
