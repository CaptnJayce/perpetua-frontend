...
export const UPGRADES: Record<string, UpgradeDef> = {
    "expand-metal-storage": {
        ...
        description: "Increases Template Metal storage capacity by 30",
        cost: (level) => [
            { resId: "tmp", amnt: 10 + level * 5 },
            { resId: "beams", amnt: 3 + level * 2 },
            { resId: "vacuum-tubes", amnt: 1 + level },
        ],
        maxPurchases: 5,
        effects: [{ type: "storage", target: "tmp", bonus: 30 }],
    },
    "expand-wood-storage": {
        id: "expand-wood-storage",
        label: "Expand Wood Storage",
        description: "Increases Blazer Wood storage capacity by 30",
        cost: (level) => [
            { resId: "tmp", amnt: 10 + level * 5 },
            { resId: "beams", amnt: 3 + level * 2 },
            { resId: "gear", amnt: 2 + level },
        ],
        maxPurchases: 5,
        effects: [{ type: "storage", target: "blazer-wood", bonus: 30 }],
    },
    "expand-fittings-storage": {
        id: "expand-fittings-storage",
        label: "Expand Fittings Storage",
        description: "Increases Template Fittings storage capacity by 20",
        cost: (level) => [
            { resId: "tmp", amnt: 8 + level * 4 },
            { resId: "beams", amnt: 2 + level },
            { resId: "vacuum-tubes", amnt: 1 + Math.floor(level / 2) },
        ],
        maxPurchases: 5,
        effects: [{ type: "storage", target: "template-fittings", bonus: 20 }],
    },
    "expand-tubes-storage": {
        id: "expand-tubes-storage",
        label: "Expand Tubes Storage",
        description: "Increases Vacuum Tubes storage capacity by 20",
        cost: (level) => [
            { resId: "tmp", amnt: 8 + level * 4 },
            { resId: "beams", amnt: 2 + level },
            { resId: "gear", amnt: 2 + level },
        ...
        maxPurchases: 5,
        effects: [{ type: "storage", target: "vacuum-tubes", bonus: 20 }],
    },
    "expand-beams-storage": {
        id: "expand-beams-storage",
        label: "Expand Beams Storage",
        description: "Increases Beams storage capacity by 20",
        cost: (level) => [
            { resId: "tmp", amnt: 8 + level * 4 },
            { resId: "gear", amnt: 2 + level },
            { resId: "vacuum-tubes", amnt: 1 + Math.floor(level / 2) },
        ...
        maxPurchases: 5,
        effects: [{ type: "storage", target: "beams", bonus: 20 }],
    },
    "faster-gathering": {
        id: "faster-gathering",
